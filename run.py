...
def run_temporal_shot_encoding(cfg: dict, frames_out_dir: str, *, overwrite: bool, quiet: bool) -> None:
    ...
    Not yet implemented; this function defines the final execution order and
    will be wired up once `pipeline.shot_encoder` and `models.temporal_transformer`
    are implemented.
    """
    # from pipeline.shot_encoder import ShotEncoder  # to be used later
    raise NotImplementedError("Temporal shot encoding stage is not yet implemented.")
...
def run_scene_clustering(cfg: dict, frames_out_dir: str, *, overwrite: bool, quiet: bool) -> None:
    ...
    Not yet implemented; this function defines the final execution order and
    will be wired up once `pipeline.clustering` is implemented.
    """
    # from pipeline.clustering import SceneClusterer  # to be used later
    raise NotImplementedError("Scene clustering stage is not yet implemented.")
...
def main() -> None:
    ...
    # Note: later stages will be invoked here in order, using the same function
    # signatures defined above, so that `python run.py` always follows the final
    # pipeline path.
